...
$mail->Username = 'megat.fst@gmail.com';                 // SMTP username
$mail->Password = 'ilovecalpis95';                           // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->From = 'megat.fst@gmail.com';
...
if(!$mail->send()) {
  ...
  $username = "syafiqq95@gmail.com";
  $hash = "712f0e5b7f4d34e3078d5cd693b5da2e1d8734a1df029ace73b90fbcf90552a6";
  $test = "0";
