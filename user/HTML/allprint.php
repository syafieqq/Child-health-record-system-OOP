			  ...
			  <?php	echo "<img src='../uploads/$dbl->n_img' width='150' height='150' alt=\"...\">" ?>
                   ...
                   <form id="contactForm" action="sendemail.php" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input style="font-size: 16px;" type="text" name="name" disabled  value="<?php  echo  $dbl->dob;  ?>" class="form-control" 
                                   placeholder="Full Name">
                        </div>
						<div class="row">
						<div class="col-md-4">
...
<?php
$measurement='Weight';
$dbl->measurement($loggedin_id,$measurement);
									?>
...
<div class='content table-responsive table-full-width'>
							<table class='table table-hover table-striped'>
<?php
$measurement='Height Circumference';
$dbl->measurement($loggedin_id,$measurement);
